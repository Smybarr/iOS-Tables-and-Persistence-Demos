...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //this allows the AppDelegate object to access the view controller 
        //to update the labels
        viewController = window?.rootViewController as? ViewController
        
        //increment the launchCount property in viewController object
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        viewController?.resignedActiveCount += 1
    }
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        viewController?.becomeBackgroundCount += 1
    }
